...
<ul>
    <li><a href="mainpage.php?link=1">Bilgilendirme</a></li>
    <li><a href="mainpage.php?link=2">Oy Kullanma Ekranı</a></li>
    <li><a href="mainpage.php?link=4">Seçmen Bilgileri</a></li>
    <li><a href="mainpage.php?link=6">Güvenli Çıkış</a></li>
...
<?php
    ...
    include("ilk.php");
    break;
    case 2 :include("oy_ekrani.php");
    break;
    case 4 :include("secmen.php");
    break;
