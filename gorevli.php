...
<ul>
    <li><a href="gorevli.php?link=3">Görevli Bilgilendirme</a></li>
    <li><a href="gorevli.php?link=1">Gizli Değer</a></li>
    <li><a href="gorevli.php?link=5">Sonuçları Getir</a></li>
...
<?php
    ...
    include("sonuc.php");
    break;
    case 5 :include("gizliveri.php");
    break;
    case 6 :include("logout.php");
    break;
    default:
    case 0: include("gorevli_bilgi.php");
                    }
    $zaman=date('Y/m/d');
